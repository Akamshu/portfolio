...
const skills: Skill[] = [
  {
    title: 'Languages',
    body: ['JavaScript', 'PHP', 'TypeScript', 'Python'],
  },
  {
  ...
  {
    title: 'Tooling',
    body: ['Linux', 'Git', 'Vercel', 'Netlify', 'Docker', 'Puter', 'AWS'],
  },
];

const educations: Education[] = [
  {
    title: 'HND Computer Science at The Federal Polytechnic, Mubi',
    endDate: 'March 2021',
    relevant: [
  ...
  {
    title: 'ND Computer Science at The Federal Polytechnic, Mubi',
    startDate: 'NOV 2016',
    endDate: 'AUG 2018',
    relevant: [],
  },
...
const certifications: Certification[] = [
  {
    title: 'PHP/FORMS - Responsive Designs',
    date: 'MAY 2020',
  },
  {
    title: 'VUE JS - MindLuster.com',
    date: 'JAN 2023',
  },
  {
    title: 'HTML/CSS - Pirple.com',
    date: 'JAN 2021',
  },
  {
    title: 'Google Digital Skills - Google',
    date: 'AUG 2017',
  },
];
...
const hobbies = ['Learning', 'Graphics Design', 'Coding', 'Football/Soccer'];
