    ...
    <div className="App">
      {isLoading ? (
        <div className="flex flex-col justify-center  items-center  h-full w-full">
          <div className="font-augustus text-[50px] "> {'<Kponkius Gabriel/>'}</div>
          <p className="font-mono w-[80%] text-center text-[#888888] ">
            ... creating wow! concept designs, no hurry in life!
          </p>
          <PercentageLoader />
        </div>
      ) : (
        <BrowserRouter>
          ...
          <div className="mobile_container">
            ...
            <div className="social_buttons">
              <a href="https://github.com/akamshu" target="_blank" rel="noopener noreferrer">
