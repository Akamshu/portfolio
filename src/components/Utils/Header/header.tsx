      ...
      <div className="header_wrapper items-center">
        <div className="logo_container">
          <Link to="/" className="flex gap-3 items-center">
            ...
            <div className="font-augustus text-[40px] ">Kponkius Gabriel</div>{' '}
        ...
        <nav>
          <div className="mobile_menu_container">
            ...
            <div className="social_box">
              ...
              <a className="mt-4" href="mailto: kponkius@gmail.com">
                Send Email
              </a>
              <div className="social_icons">
                <a href="https://github.com/akamshu">
                  <i className="fab fa-github"></i>
                </a>
                <a href="https://twitter.com/kponkius">
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="https://www.linkedin.com/in/kponkius-gabriel">
