  ...
  return (
    <div id="success">
      <div className="error_container">
        ...
        <p>Thanks for reaching out to Kponkius. I will reply as soon as possible normally takes less than 24 hours </p>
        <div className="go_button_container" style={{ display: 'flex' }}>
          <button onClick={props.display}>Thank you, Kponkius Client</button>
        </div>
      </div>
    </div>
  );
...
export default class MyForm extends React.Component<any, IState> {
  ...
  render() {
    ...
    return (
      <div>
        <form name="contact" method="post" action="https://formspree.io/f/xkgvkgge" onSubmit={this.submitForm}>
